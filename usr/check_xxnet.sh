...
ok() {
  ...
  echo ${fk}|grep -q "http://www.google.com/" && echo "XX-Net is OK." && return 0 || echo "XX-net is not OK." && return 1
}
...
xxnet() {
  ...
  echo "Restart XX-Net." && sudo systemctl restart miredo && /home/xx/Downloads/XX-Net-3.9.6/start
}
